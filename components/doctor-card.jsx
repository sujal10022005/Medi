    ...
    <Card className="border-emerald-900/20 hover:border-emerald-700/40 transition-all">
        <CardContent className="pt-4">
            <div className='flex items-start gap-4'>
                <div className='w-12 h-12 rounded-full bg-emerald-900/20 flex items-centre justify-center flex-shrink-0'>
                {doctor.imageUrl ? (
                    <img
                        src={doctor.imageUrl}
                        alt={doctor.name}
                ...
                <div className='flex-1'>
                    <div className='flex flex-col sm:flex-row sm:items-centre sm:justify-between gap-2 mb-2'>
